...
public class ThirdActivity3 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        botao_reservar.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intentReservar = new Intent(ThirdActivity3.this, Reserva.class);
        ...
        down_arrow.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent intent = new Intent(ThirdActivity3.this, SecondActivity3.class);

                Pair[] pairs = new Pair[1];
                pairs[0] = new Pair<View, String>(down_arrow, "quarto_luxo_transition");
