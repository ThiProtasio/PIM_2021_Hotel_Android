...
public class SecondActivity4 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        second_back_arrow.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(SecondActivity4.this, MainActivity.class);
        ...
        second_arrow_up.setOnClickListener((view) -> {
            ...
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(SecondActivity4.this, pairs);
